(function() {
    'use strict';
    angular.module('stringGameLogic',[]).service('stringGameManager', function(stringGameDataService,$log,$timeout) {
        this.delay = 1000;
        this.delayedTriggerHolder = null;
        this.delayedTriggerHolder2 = false;
        this.positionToInsert = {};
        this.questionNumber = {};
        this.displayQuestion = "some random stuff";
    ...
    //    this.tiles = arrowGameService.tiles;
      ...
      // show/hide UI options
        ...
        this.initialiseGame = function(nameOfStrategy,gameType) {
          var self = this;
          var promise = stringGameDataService.getGameData(nameOfStrategy +".json");
        ...
        //    arrowGameService.buildDataForGame(gameData,gameType);
          //  arrowGameService.buildEmptyGameBoard();
           ...
           // this.factContent = arrowGameService.getFactContent();
            this.reinit();
            this.showGameDisplayQuestion();
        };

        this.showGameDisplayQuestion = function () {
          console.log(this.gameData);
          var q = this.gameData.questionList[0].Q;

          this.displayQuestion = "new bew ";
          console.log(q);
        };
